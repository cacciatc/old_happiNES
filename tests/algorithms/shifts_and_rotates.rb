...
class ShiftsAndRotatesTest < Test::Unit::TestCase
	...
	def test_16_bit_multiplied_by_2
		instr = [0xA9,0x01,0x85,0x00,0x85,0x01,0x06,0x00,0x26,0x01,0x02]
	...
	def test_16_bit_divided_by_2
		instr = [0xA9,0x02,0x85,0x00,0x85,0x01,0x46,0x01,0x66,0x00,0x02]
		write_input_file(instr)
		system(".././2a03 #{@input_file} #{@temp_file}")
		f = File.new(@temp_file)
		fstring = f.readlines
	...
	def test_signed_16_bit_divided_by_2
		instr = [0xA9,0xFE,0x85,0x00,0xA9,0xFF,0x85,0x01,0xA5,0x01,0x0A,0x66,0x01,0x66,0x00,0x02]
		write_input_file(instr)
		system(".././2a03 #{@input_file} #{@temp_file}")
		f = File.new(@temp_file)
		fstring = f.readlines
