...
class ADCTest < Test::Unit::TestCase
	...
	def test_addr_mode_indirect_y
		instr = [0xA9,0x02,0x85,0x00,0xA9,0x05,0x85,0x06,0xA9,0x01,0xA0,0x00,0x71,0x05]
		write_input_file(instr)
		system(".././2a03 #{@input_file} #{@temp_file}")
		f = File.new(@temp_file)
		fstring = f.readlines
		...
		instr = [0xA9,0x00,0x85,0x00,0xA9,0x05,0x85,0x06,0xA9,0x00,0xA0,0x00,0x71,0x05]
		write_input_file(instr)
		system(".././2a03 #{@input_file} #{@temp_file}")
		f = File.new(@temp_file)
		fstring = f.readlines
		...
		instr = [0xA9,0x80,0x85,0x00,0xA9,0x05,0x85,0x06,0xA9,0x01,0xA0,0x00,0x71,0x05]
		write_input_file(instr)
		system(".././2a03 #{@input_file} #{@temp_file}")
		f = File.new(@temp_file)
		fstring = f.readlines
