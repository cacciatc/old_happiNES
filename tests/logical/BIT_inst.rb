...
class BITTest < Test::Unit::TestCase
	...
	def test_addr_mode_zero_page
		instr = [0xA9,0xC0,0x85,0x55,0xA9,0xCC,0x24,0x55]
		...
		instr = [0xA9,0x80,0x85,0x55,0xA9,0x00,0x24,0x55]
		write_input_file(instr)
		system(".././2a03 #{@input_file} #{@temp_file}")
		f = File.new(@temp_file)
		fstring = f.readlines
		...
		instr = [0xA9,0x11,0x85,0x55,0xA9,0x01,0x24,0x55]
		write_input_file(instr)
		system(".././2a03 #{@input_file} #{@temp_file}")
		f = File.new(@temp_file)
		fstring = f.readlines
	...
	def test_addr_mode_absolute
		instr = [0xA9,0xC0,0x85,0x45,0xA9,0xCC,0x2C,0x45,0x00]
		write_input_file(instr)
		system(".././2a03 #{@input_file} #{@temp_file}")
		f = File.new(@temp_file)
		fstring = f.readlines
		...
		instr = [0xA9,0x80,0x85,0x45,0xA9,0x00,0x2C,0x45,0x00]
		write_input_file(instr)
		system(".././2a03 #{@input_file} #{@temp_file}")
		f = File.new(@temp_file)
		fstring = f.readlines
		...
		instr = [0xA9,0x11,0x85,0x45,0xA9,0x01,0x2C,0x45,0x00]
		write_input_file(instr)
		system(".././2a03 #{@input_file} #{@temp_file}")
		f = File.new(@temp_file)
		fstring = f.readlines
