...
class STYTest < Test::Unit::TestCase
	...
	def test_addr_mode_zero_page
		instr = [0xA0,0x30,0x84,0xFF,0xA0,0x00,0xA4,0xFF]
	...
	def test_addr_mode_zero_page_x
		instr = [0xA0,0x30,0xA2,0x11,0x94,0xEE,0xA0,0x00,0xA4,0xFF]
		write_input_file(instr)
		system(".././2a03 #{@input_file} #{@temp_file}")
		f = File.new(@temp_file)
		fstring = f.readlines
	...
	def test_addr_mode_absolute
		instr = [0xA0,0x30,0x8C,0xFF,0x00,0xA0,0x00,0xA4,0xFF]
		write_input_file(instr)
		system(".././2a03 #{@input_file} #{@temp_file}")
		f = File.new(@temp_file)
		fstring = f.readlines
